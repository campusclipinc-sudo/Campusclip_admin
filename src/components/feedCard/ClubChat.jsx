...
import { useGetClubChatMessages, useSendClubChatMessage } from '../../hooks/useRQClub';
import '../../scss/components/_clubChat.scss';

const ClubChat = ({ roomId, clubName }) => {
  ...
  const {
    ...
    error,
    refetch,
  } = useGetClubChatMessages(roomId, { page: 1, limit: 50 });

  const sendMessageMutation = useSendClubChatMessage(roomId, () => {
    setMessage('');
  });
    ...
    <div className="club-chat-container">
      ...
      <div className="club-chat-header">
        ...
        <div className="club-chat-header-content">
          ...
          <p className="club-chat-subtitle">Connect with your club members</p>
        </div>
      </div>
